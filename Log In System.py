    ...
    with open("Logins.txt", "r") as f:
        ...
        if username_right:
            if password_right:
                ...
                Erode_Button.grid(row=9, column=1)
                Gaussian_Button.grid(row=12, column=1)
                Median_Button.grid(row=15, column=1)
                Bilateral_Button.grid(row=17, column=1)
...
def sign_out():
    ...
    if True:
        ...
        Gaussian_Button.grid_forget()
        Median_Button.grid_forget()
        Bilateral_Button.grid_forget()
...
def switch():
    ...
    random_thing1 = random.randint(0, 9)
    random_thing2 = random.randint(0, 9)
    imagechoice1 = list(images.values())[random_thing1]
    imagechoice2 = list(images.values())[random_thing2]
    thingyyy1 = list(images.keys())[random_thing1]
    thingyyy2 = list(images.keys())[random_thing2]
...
def GaussianBlur():
    cv2.imshow("Gaussian image", cv2.GaussianBlur(imagechoice1, (13, 13), 0))
    
def MedianBlur():
    cv2.imshow("Median image", cv2.medianBlur(imagechoice1, 13))
    
def BilateralBlur():
    cv2.imshow("Bilateral image", cv2.bilateralFilter(imagechoice1, 37, 13, 13))
...
Gaussian_Button = tk.Button(root, text="Gaussian", command=GaussianBlur, bg="lightgrey")
Median_Button = tk.Button(root, text="Median", command=MedianBlur, bg="lightgrey")
Bilateral_Button = tk.Button(root, text="Bilateral", command=BilateralBlur, bg="lightgrey")
